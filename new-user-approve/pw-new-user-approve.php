...
if (!class_exists("PW_New_User_Approve")) {
    ...
    class PW_New_User_Approve {
        ...
        private function __construct() {
            ...
            add_action("user_register", [$this, "delete_new_user_approve_transient"], 11);
            add_action("new_user_approve_approve_user", [$this, "delete_new_user_approve_transient"], 11);
            add_action("new_user_approve_deny_user", [$this, "delete_new_user_approve_transient"], 11);
            add_action("deleted_user", [$this, "delete_new_user_approve_transient"]);
            ...
            add_action("woocommerce_created_customer", [$this, "nua_welcome_email_woo_new_user"]);
            add_action("lostpassword_post", [$this, "lost_password"], 99, 2);
            add_action("user_register", [$this, "add_user_status"]);
            add_action("user_register", [$this, "request_admin_approval_email_2"]);
            add_action("new_user_approve_approve_user", [$this, "approve_user"]);
            add_action("new_user_approve_deny_user", [$this, "deny_user"]);
            add_action("new_user_approve_deny_user", [$this, "update_deny_status"]);
            ...
            add_filter("registration_errors", [$this, "show_user_pending_message"], 99);
            add_filter("login_message", [$this, "welcome_user"]);
            add_filter("new_user_approve_validate_status_update", [$this, "validate_status_update"], 10, 3);
            add_filter("shake_error_codes", [$this, "failure_shake"]);
            add_filter("woocommerce_registration_auth_new_customer", [$this, "disable_woo_auto_login"]);
            add_action("woocommerce_checkout_order_processed", [$this, "disable_woo_auto_login_on_checkout"]);
            ...
            add_filter("pmpro_setup_new_user", [$this, "allow_pmpro_setup_user"], 20, 4);
        ...
        public function admin_loaded() {
            ...
            if ($user_admin_integration) {
                ...
                require_once __DIR__ . "/includes/end-points/mobile-api.php";
        ...
        public function get_count_of_user_statuses() {
            $user_statuses = get_option("new_user_approve_user_statuses_count", []);
        ...
        public function nua_admin_scripts() {
            ...
            wp_enqueue_style("nua-fonts", plugins_url("/assets/css/nua-fonts.css", __FILE__), [], NUA_VERSION);
            if (isset($_GET["page"]) && in_array($_GET["page"], $pages)) {
                wp_enqueue_script("jquery");
                wp_enqueue_editor();
                wp_enqueue_media();
                wp_enqueue_script("new-user-approve-buildjs", plugins_url("/build/index.js", __FILE__), ["wp-blocks", "wp-block-library", "wp-element", "wp-i18n", "wp-components", "wp-editor", "wp-data"], NUA_VERSION, true);
                wp_enqueue_style("new-user-approve-buildcss", plugins_url("/build/style-index.css", __FILE__));
                wp_enqueue_style("nua-admin-style", plugins_url("/assets/css/nua-admin-style.css", __FILE__), ["nua-fonts"], NUA_VERSION);
                ...
                wp_enqueue_script("nua-admin", plugins_url("/assets/js/admin.js", __FILE__), ["jquery"], NUA_VERSION);
		    ...
		    <div>
			    <p>
				    <span style="font-weight:bold;">
					    <a href="<?php echo wp_kses_post(apply_filters("new_user_approve_dashboard_link", "users.php")); ?>"><?php esc_html_e("Users", "new-user-approve"); ?></a>
				    </span>:
        ...
        public function nua_welcome_email_woo_new_user($customer_id) {
            ...
            $disable_welcome_email = apply_filters("disable_welcome_email_woo_new_user", [$this, false]);
