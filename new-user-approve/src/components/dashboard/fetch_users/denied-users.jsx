  ...
  const fetchDeniedUsers = async () => {
    try {
      ...
      const response = await axios.get(
        `${
          NUARestAPI.get_denied_users + NUARestAPI.permalink_delimeter
    ...
    <div className="denied_users_list">
      <div className="all_users_list_header">
        <h2 className="users_list_title">
          {" "}
          {__("Denied Users", "new-user-approve")}
        </h2>
        {/* search field */}
      ...
      <TableContainer
        className="denied_users_tbl_container usersTable"
        component={Paper}
        sx={{ overflowX: "auto" }}
      >
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={dynamicColumns.length || 5}>
                  <div
                    className="user-list-empty denied-user-empty-list"
