      ...
      <Tabs className="integration_subtabs" defaultValue={1}>
        <TabsList className="integration_subtabs_list zapier-tab">
          <Tab value={1}>
            {" "}
            {zapierIcon}
            {__("Zapier", "new-user-approve")}
          </Tab>
        </TabsList>

        <TabPanel value={1}>
          <Integrate platform="zapier" />
        </TabPanel>
      </Tabs>
    </React.Fragment>
  );
