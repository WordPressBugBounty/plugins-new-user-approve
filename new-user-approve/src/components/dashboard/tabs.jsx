...
const NUA_Dash_Tabs = () => {
  ...
  let users_icon = (
    ...
    >
      {" "}
      <path
        d="M6.57757 15.1335C5.1628 15.8917 1.45336 17.4398 3.71266 19.377C4.81631 20.3233 6.04549 21.0001 7.59087 21.0001H16.4091C17.9545 21.0001 19.1837 20.3233 20.2873 19.377C22.5466 17.4398 18.8372 15.8917 17.4224 15.1335C14.1048 13.3556 9.89519 13.3556 6.57757 15.1335Z"
        fill="#242424"
      />{" "}
      <path
  ...
  let invitation_icon = (
    ...
    >
      <path
        d="M4 9.36L12 14.36L20 9.36L12 4.36L4 9.36ZM22 9.36V19.36C22 19.8904 21.7893 20.3991 21.4142 20.7742C21.0391 21.1493 20.5304 21.36 20 21.36H4C3.46957 21.36 2.96086 21.1493 2.58579 20.7742C2.21071 20.3991 2 19.8904 2 19.36V9.36C2 8.63 2.39 8 2.97 7.65L12 2L21.03 7.65C21.61 8 22 8.63 22 9.36Z"
        fill="#242424"
      />
    </svg>
  );
  let auto_approve_icon = (
    ...
    >
      <path
        d="M14.9258 12.7775L12.7775 10.6292C12.4847 10.3364 12.3383 10.19 12.1803 10.1117C11.8798 9.96277 11.527 9.96277 11.2264 10.1117C11.0685 10.19 10.9221 10.3364 10.6292 10.6292C10.3364 10.9221 10.19 11.0685 10.1117 11.2264C9.96277 11.527 9.96277 11.8798 10.1117 12.1803C10.19 12.3383 10.3364 12.4847 10.6292 12.7775L12.7775 14.9258M14.9258 12.7775L21.3708 19.2225C21.6636 19.5153 21.81 19.6617 21.8883 19.8197C22.0372 20.1202 22.0372 20.473 21.8883 20.7736C21.81 20.9315 21.6636 21.0779 21.3708 21.3708C21.0779 21.6636 20.9315 21.81 20.7736 21.8883C20.473 22.0372 20.1202 22.0372 19.8197 21.8883C19.6617 21.81 19.5153 21.6636 19.2225 21.3708L12.7775 14.9258M14.9258 12.7775L12.7775 14.9258L14.9258 12.7775Z"
        fill="#242424"
      />
      <path
        d="M18 2L18.2948 2.7966C18.6813 3.84117 18.8746 4.36345 19.2556 4.74445C19.6366 5.12545 20.1588 5.31871 21.2034 5.70523L22 6L21.2034 6.29477C20.1588 6.68129 19.6366 6.87456 19.2556 7.25555C18.8746 7.63655 18.6813 8.15883 18.2948 9.2034L18 10L17.7052 9.2034C17.3187 8.15884 17.1254 7.63655 16.7444 7.25555C16.3634 6.87455 15.8412 6.68129 14.7966 6.29477L14 6L14.7966 5.70523C15.8412 5.31871 16.3634 5.12545 16.7444 4.74445C17.1254 4.36345 17.3187 3.84117 17.7052 2.7966L18 2Z"
        fill="#242424"
      />
      <path
        d="M5 4L5.22108 4.59745C5.51097 5.38087 5.65592 5.77259 5.94167 6.05834C6.22741 6.34408 6.61913 6.48903 7.40255 6.77892L8 7L7.40255 7.22108C6.61913 7.51097 6.22741 7.65592 5.94166 7.94167C5.65592 8.22741 5.51097 8.61913 5.22108 9.40255L5 10L4.77892 9.40255C4.48903 8.61913 4.34408 8.22741 4.05833 7.94167C3.77259 7.65592 3.38087 7.51097 2.59745 7.22108L2 7L2.59745 6.77892C3.38087 6.48903 3.77259 6.34408 4.05833 6.05833C4.34408 5.77259 4.48903 5.38087 4.77892 4.59745L5 4Z"
        fill="#242424"
      />
    </svg>
  );
  ...
  return (
    <Tabs
      className="nua_dash_parent_tabs"
    ...
    >
      <TabsList className="nua_dash_parent_tablist">
        ...
        {nuaAdmin.nua_users_cap && (
          <Tab
            ...
            onClick={() =>
              (window.location.hash = "#/action=users/tab=all-users")
            }
            datatarget={"users"}
          >
            <span>
        ...
        {nuaAdmin.nua_view_invitation_tab && (
          <Tab
            ...
            to={"/action=inv-codes"}
            className={
              currentTab === "action=inv-codes" ? "nua_active_tab" : ""
            }
            onClick={() =>
              (window.location.hash = "#/action=inv-codes/tab=all-codes")
            }
            datatarget={"inv code"}
          >
            <span>
        ...
        {nuaAdmin.nua_auto_approve_cap && (
          <Tab
            ...
            className={
              currentTab == "action=auto-approve" ? "nua_active_tab" : ""
            }
            onClick={() =>
              (window.location.hash = "#/action=auto-approve/tab=whitelist")
            }
        ...
        {nuaAdmin.nua_integration_cap && (
          <Tab
            ...
            className={
              currentTab == "action=integrations" ? "nua_active_tab" : ""
            }
        ...
        {nuaAdmin.nua_settings_cap && (
          <Tab
            ...
            onClick={() =>
              (window.location.hash = "#/action=settings/tab=general")
            }
          >
            <span>
              {setting_icon}
      ...
      {nuaAdmin.nua_view_invitation_tab && (
        <TabPanel
          className="invitation-main-tabpanel"
          value={"action=inv-codes"}
          index="inv-codes"
        >
          <Add_Code_SubTabs />
      ...
      {nuaAdmin.nua_auto_approve_cap && (
        <TabPanel
          className="auto-approve-main-tabpanel"
          value={"action=auto-approve"}
          index="auto-approve"
        >
          <Auto_Approve />
      ...
      {nuaAdmin.nua_integration_cap && (
        <TabPanel
          className="integration-main-tabpanel"
          value={"action=integrations"}
        >
          <Integrations />
        </TabPanel>
      ...
      {nuaAdmin.nua_settings_cap && (
        <TabPanel
          className="setting-main-tabpanel generalTabPage"
          value={"action=settings"}
        >
          <Settings />
        </TabPanel>
